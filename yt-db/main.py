...
#defining functions that style the data according to whether there has been a gain or a loss accordingly
...
#function to divide subscriber audiences
...
#this is used to reload the data so that we dont have to call the run streamlit command again and again
@st.cache
#function to load data instead of recalling all steps again and again
def load_data():
...
#this will allow us to build the dashboard
...
if add_sidebar == 'Aggregate Metrics':
    ...
    #will list the metric of views from the past 6 months (aka the median of views)
...
if add_sidebar == 'Individual Video Analysis':
    ...
    fig2.update_layout(title='View comparison first 30 days', xaxis_title='Days Since Published',
